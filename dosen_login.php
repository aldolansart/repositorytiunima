...
<head>
    ...
    <title>Login Dosen | Repository Laporan Kerja Prakek TI UNIMA</title>
    ...
    <div class="error-pagewrap">
        <div class="error-page-int">
            <div class="text-center m-b-md custom-login">
                ...
                <h4>REPOSITORY LAPORAN KERJA PRAKTEK TI UNIMA</h4>
            ...
            <div class="content-error">
                ...
                <div class="hpanel">
                    <div class="panel-body">
                       ...
                       <form action="periksa_dosen_login.php" method="POST" id="loginForm">
            ...
            <div class="text-center login-footer">
                <p class="text-muted">Copyright © <?php echo date('Y') ?>. Repository Laporan Kerja Praktek TI UNIMA</p>
            </div>
        </div>   
    </div>
