...
<head>
    ...
    <title>Mahasiswa - Repository Laporan Kerja Praktek TI UNIMA</title>
    ...
    include '../koneksi.php';
    session_start();
    if($_SESSION['status'] != "mahasiswa_login"){
    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="index.html"><img class="main-logo" src="../assets/img/logo/repo.png" alt="" /></a>
                <strong><a href="index.html"><img src="../assets/img/logo/repo.png" alt="" /></a></strong>
            </div>
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                ...
                <nav class="sidebar-nav left-sidebar-menu-pro" style="margin-top: 30px">
                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            <a href="laporan.php" aria-expanded="false"><span class="educate-icon educate-data-table icon-wrap sub-icon-mg" aria-hidden="true"></span> <span class="mini-click-non">Laporan Saya</span></a>
                        </li>

                        <li>
                            <a href="kategori.php" aria-expanded="false"><span class="educate-icon educate-course icon-wrap sub-icon-mg" aria-hidden="true"></span> <span class="mini-click-non">Data Dosen KP</span></a>
                        </li>
                                    ...
                                    <div class="col-lg-5 col-md-6 col-sm-12 col-xs-12">
                                        <div class="header-top-menu tabl-d-n">
                                            <ul class="nav navbar-nav mai-top-nav">
                                                <li class="nav-item"><a href="#" class="nav-link">Repository Laporan Kerja Praktek TI UNIMA</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                        ...
                                        <div class="header-right-info">
                                                ...
                                                <li class="nav-item">
                                                    ...
                                                    <div role="menu" class="notification-author dropdown-menu animated zoomIn">
                                                        <div class="notification-single-top">
                                                            <h1>Riwayat unduh laporan saya</h1>
                                                        </div>
                                                        <ul class="notification-menu">
                                                            <?php 
                                                            $id_saya = $_SESSION['id'];
                                                            $laporan = mysqli_query($koneksi,"SELECT * FROM riwayat,laporan,dosen WHERE riwayat_laporan=laporan_id and riwayat_dosen=dosen_id and laporan_mahasiswa='$id_saya' ORDER BY riwayat_id DESC");
                                                                    ...
                                                                    <a href="riwayat.php">
                                                                        <div class="notification-content">
                                                                           <p>
                                                                            ...
                                                                            <br>
                                                                            <b><?php echo $p['dosen_nama'] ?></b> menunduh <b><?php echo $p['laporan_nama'] ?></b>.
                                                                        </p>
                                                                    </div>
                                                                </a>
                                                                <hr>
                                            ...
                                            <li class="nav-item">
                                                <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
                                                    ...
                                                    $profil = mysqli_query($koneksi,"select * from mahasiswa where mahasiswa_id='$id_mahasiswa'");
                                                    $profil = mysqli_fetch_assoc($profil);
                                                    if($profil['mahasiswa_foto'] == ""){ 
                                                      ?>
                                                      <img src="../gambar/sistem/dosen.png" style="width: 20px;height: 20px">
                                                  <?php }else{ ?>
                                                    <img src="../gambar/mahasiswa/<?php echo $profil['mahasiswa_foto'] ?>" style="width: 20px;height: 20px">
                                                <?php } ?>
                                                <span class="admin-name"><?php echo $_SESSION['nama']; ?> [ <b>Mahasiswa</b> ]</span>
                    ...
                    <div class="mobile-menu">
                        <nav id="dropdown">
                            <ul class="mobile-menu-nav">
                                ...
                                <li>
                                    <a href="mahasiswa.php" aria-expanded="false"><span class="educate-icon educate-event icon-wrap sub-icon-mg" aria-hidden="true"></span> <span class="mini-click-non">Mahasiswa</span></a>
                                </li>

                                <li>
                                    <a href="dosen.php" aria-expanded="false"><span class="educate-icon educate-event icon-wrap sub-icon-mg" aria-hidden="true"></span> <span class="mini-click-non">Dosen</span></a>
                                </li>

                                <li>
                                    <a href="riwayat.php" aria-expanded="false"><span class="educate-icon educate-form icon-wrap sub-icon-mg" aria-hidden="true"></span> <span class="mini-click-non">Dosen</span></a>
                                </li>
