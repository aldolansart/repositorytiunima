                    ...
                    <ul class="list-inline two-part-sp">
                        ...
                        <li class="text-right sp-cn-r">
                            ...
                            <span class="counter text-success">
                                ...
                                ?>
                                <span class="counter"><?php echo mysqli_num_rows($jumlah_mahasiswa); ?></span>
                            </span>
                        </li>
                    </ul>
                </div>
                    ...
                    <ul class="list-inline two-part-sp">
                        ...
                        <li class="text-right graph-two-ctn">
                            ...
                            <span class="counter text-purple">
                                <?php 
                                $jumlah_dosen = mysqli_query($koneksi,"select * from dosen");
                                ?>
                                <span class="counter"><?php echo mysqli_num_rows($jumlah_dosen); ?></span>
                            </span>
                        </li>
                    </ul>
                </div>
                    ...
                    <ul class="list-inline two-part-sp">
                        ...
                        <li class="text-right graph-three-ctn">
                            ...
                            <span class="counter text-info">
                                <?php 
                                $jumlah_laporan = mysqli_query($koneksi,"select * from laporan");
                                ?>
                                <span class="counter"><?php echo mysqli_num_rows($jumlah_laporan); ?></span>
                            </span>
                        </li>
                    </ul>
                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="caption pro-sl-hd">
                                    <span class="caption-subject"><b>Grafik pengunduhan Laporan KP</b></span>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="actions graph-rp graph-rp-dl">
                                    <p>Grafik jumlah unduh laporan KP perhari selama sebulan</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="single-cards-item">
                    ...
                    <div class="single-product-text">
                        ...
                        if($s['mahasiswa_foto'] == ""){
                            ...
                            ?>
                            <img class="img-user" src="../gambar/mahasiswa/<?php echo $s['mahasiswa_foto']; ?>">
                            <?php
                        }
                        ?>
