...
<head>
    ...
    <title>Login Admin | Repository Laporan Kerja Praktek TI UNIMA</title>
    ...
    <div class="error-pagewrap">
        <div class="error-page-int">
            <div class="text-center m-b-md custom-login">
                <h3>REPOSITORY</h3>
                <h4>Laporan Kerja Praktek Teknik Informatika UNIMA</h4>
                <br>
            ...
            <div class="text-center login-footer">
                <p class="text-muted">Copyright © <?php echo date('Y') ?>. Repository Laporan Kerja Praktek Teknik Informatika UNIMA</p>
            </div>
        </div>   
    </div>
