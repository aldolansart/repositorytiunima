		...
		<div class="row">
			<div class="col-lg-12">
				<div class="footer-copy-right">
					<p>Copyright © <?php echo date('Y') ?>. Repository Laporan Kerja Praktek Teknik Informatika UNIMA.</p>
				</div>
			</div>
		</div>
	</div>
...
<script type="text/javascript">
	$(document).ready( function () {
		...
		Morris.Area({
			...
			$laporan = mysqli_query($koneksi,"SELECT * FROM riwayat WHERE date(riwayat_waktu) >= '$awal' AND date(riwayat_waktu) <= '$akhir'");
