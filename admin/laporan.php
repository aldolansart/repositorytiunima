...
<div class="container-fluid">
    <div class="panel panel">
        ...
        <div class="panel-heading">
            <h3 class="panel-title">Semua laporan</h3>
        </div>
            ...
            <table id="table" class="table table-bordered table-striped table-hover table-datatable">
                ...
                <tbody>
                    ...
                    while($p = mysqli_fetch_array($laporan)){
                        ...
                        <tr>
                            <td><?php echo $no++; ?></td>
                            <td><?php echo date('H:i:s  d-m-Y',strtotime($p['laporan_waktu_upload'])) ?></td>
                            <td>

                                <b>KODE</b> : <?php echo $p['laporan_kode'] ?><br>
                                <b>Nama</b> : <?php echo $p['laporan_nama'] ?><br>
