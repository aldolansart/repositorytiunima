...
<head>
    ...
    <title>Admin - Repository Laporan Kerja Praktek</title>
            ...
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                ...
                <nav class="sidebar-nav left-sidebar-menu-pro" style="margin-top: 30px">
                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            <a href="mahasiswa.php" aria-expanded="false"><span class="educate-icon educate-professor icon-wrap sub-icon-mg" aria-hidden="true"></span> <span class="mini-click-non">Data Mahasiswa</span></a>
                        </li>

                        <li>
                            <a href="dosen.php" aria-expanded="false"><span class="educate-icon educate-professor icon-wrap sub-icon-mg" aria-hidden="true"></span> <span class="mini-click-non">Data Dosen</span></a>
                        </li>

                        <li>
                            <a href="laporan.php" aria-expanded="false"><span class="educate-icon educate-data-table icon-wrap sub-icon-mg" aria-hidden="true"></span> <span class="mini-click-non">Data laporan</span></a>
                        </li>
                                    ...
                                    <div class="col-lg-5 col-md-6 col-sm-12 col-xs-12">
                                        <div class="header-top-menu tabl-d-n">
                                            <ul class="nav navbar-nav mai-top-nav">
                                                <li class="nav-item"><a href="#" class="nav-link"><b>REPOSITORY LAPORAN KERJA TEKNIK INFORMATIKA UNIMA</b></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                                ...
                                                <li class="nav-item">
                                                    ...
                                                    <div role="menu" class="notification-author dropdown-menu animated zoomIn">
                                                        ...
                                                        <ul class="notification-menu">
                                                            <?php 
                                                            $laporan = mysqli_query($koneksi,"SELECT * FROM riwayat,laporan,dosen WHERE riwayat_laporan=laporan_id and riwayat_dosen=dosen_id ORDER BY riwayat_id DESC");
