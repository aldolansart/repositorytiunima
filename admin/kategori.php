                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="breadcome-heading">
                                <h4 style="margin-bottom: 0px">Dosen Pembimbing KP</h4>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
...
<div class="container-fluid">
    <div class="panel panel">
        ...
        <div class="panel-heading">
            <h3 class="panel-title">Data Dosen Pembimbing KP</h3>
        </div>
        <div class="panel-body">


            <div class="pull-right">
                <a href="kategori_tambah.php" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Data Dosen</a>
            </div>
